...
class ModuleFactory: IModuleFactory {
    ...
    func makeNewsViewController() -> UIViewController {
        NewsViewController(viewModel: NewsViewModel(networkService: services.networkService))
    }
    ...
    func makeWeatherViewController() -> UIViewController {
        WeatherViewController(viewModel: WeatherViewModel(networkService: services.networkService))
    }
